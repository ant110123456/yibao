...
public class runtestgethmackey {
	...
	public static void main(String[] args) throws IOException {
		...
		getHmacKey("10015004197","10014929805");

	}

	public static String getHmacKey(String merchantNo,String parentMerchantNo) throws IOException{
