...
public class runtestdivbill {
	...
	public static void main(String[] args) throws IOException {
		...
		request.addParam("dayString", "2019-12-26");
		...
		YopResponse response = YopRsaClient.get("/yos/v1.0/std/bill/dividedaydownload", request);
		...
		*/
		String result = new BufferedReader(new InputStreamReader(retstream)).lines().collect(Collectors.joining(System.lineSeparator()));
